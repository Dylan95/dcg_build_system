...
4.  Usage
	...
	Configuration files: "dcg_build_system/config/*.json"
		By default the only config file is "config/config.json", but you can split up the configuration into any number of files, and they will be recursively merged together to form a single configuration.  This is useful for organization, and may be useful for integration with other tools.
